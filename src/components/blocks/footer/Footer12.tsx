        ...
        <div className="row gy-6 gy-lg-0">
          <div className="col-md-4 col-lg-4">
            <div className="widget">
              ...
              <p className="mb-4">
                © 2024 Montreal International Education Center. <br className="d-none d-lg-block" />
                All rights reserved.
              </p>
          ...
          <div className="col-md-4 col-lg-4">
            <div className="widget">
              ...
              <address className="pe-xl-15 pe-xxl-17">Old Port, Montreal, Quebec, Canada</address>
