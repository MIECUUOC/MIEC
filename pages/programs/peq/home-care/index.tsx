...
const HomeCarePage: NextPage = () => {
    ...
    const contentList = {
        title1: "MIEC - PEQ",
        title2: "护理专业",
        title3: "护理事业是现代社会的重要支柱, 护理专业人才需求巨大,发展前景广阔. 在我们870小时的认证课程中, 您将掌握成为一名优秀护理工作者所需的全面技能. 作为一名护理人员, 您将有机会帮助病患康复, 为长者提供悉心照料, 用爱心点亮他人的生命之光. 让我们携手踏上这段神圣的护理之旅, 成就卓越, 铸就辉煌!",
        title4:"掌握护理技能, 成就璀璨人生",
        title5:"理论实践并重, 培养护理精英",
        title6:"护理专业前景, 就业机会广阔",
        title7:"资深护理导师, 助您实现梦想",
        title8:"护理英才, 铸就非凡人生",
        title9:"系统专业课程, 成就护理精英",
        title10:"我院护理课程由资深护理专家精心设计, 涵盖护理学各个领域. 从解剖生理学基础到临床护理实践, 从老年护理到儿科护理, 15个环环相扣的教学模块, 让您循序渐进, 全面掌握. 通过系统的理论学习和实践操作, 您将具备扎实的专业知识和过硬的实践技能, 成长为一名优秀的护理人才",
        title11:"点亮生命之光, 护理梦想起航",
        title12:"马上报名, 成就卓越护理人才",
        title13:"问题解答",
        title14:"常见问题专区"
    }
    ...
    const accordions =  [
        {
            ...
            expand: false,
            heading: '官方认证, 品质保障',
            body:'我院是魁北克省教育部认可的大专职业教育机构, 护理专业培养项目经过严格评估, 获得官方认证. 完成学业后, 您获得魁北克省颁发的专业文凭, 这将是您护理事业的敲门砖, 为您今后的职业发展奠定坚实基础'
        },
        {
            no: 'Two',
            expand: false,
            heading: '理论实践, 技能为本',
            body:'我院开设的870小时护理专业课程在业内享有盛誉. 课程全面涵盖护理领域的15项核心技能, 理论与实践紧密结合, 强调动手操作能力. 通过大量的实习实训环节, 确保学生掌握扎实的专业知识和娴熟的实践技能'
        },
        {
            no: 'Three',
            expand: false,
            heading: '前景广阔, 空间无限',
            body:'魁北克省乃至全加拿大的护理人才需求旺盛, 就业前景十分广阔. 无论是在大型医院担任重要护理岗位, 还是为社区护理事业贡献才智您都可以. 作为我院的护理专业毕业生, 您都将拥有一片充满机遇的广阔天地'
        }
    ];
    ...
    const serviceList2 = [
        ...
        },
        {
            ...
            title: "助力移民事业",
            icon: 'uil-chart-line',
            description:"护理专业是魁北克省紧缺人才职业之一, 属于优先移民类别. 通过我院的专业学习, 您不仅能掌握实用的护理技能, 还能满足该省技术移民的申请条件, 为移民加拿大铺平道路,实现人生梦想"
        }
    ];
